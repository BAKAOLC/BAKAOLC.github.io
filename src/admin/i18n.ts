...
const messages = {
  zh: {
    ...
    assets: {
      ...
      dropTitle: '上传到 {directory}', dropBody: '松开即可保存文件', type: '类型', copyPath: '复制路径', moveRename: '移动或改名', selected: '已选择 {count} 项', useSelected: '使用所选文件', useCount: '使用 {count} 个文件',
      ...
      loadFailed: '文件加载失败', noAccepted: '没有符合当前字段类型的文件。', uploadDone: '{count} 个文件已上传到 {directory}', uploadFailed: '上传失败', copied: '公开路径已复制', copyFailed: '无法写入剪贴板，请手动复制路径。', folderUpdated: '文件夹已更新为 {path}', fileUpdated: '文件已更新为 {path}',
  ...
  en: {
    ...
    assets: {
      ...
      dropTitle: 'Upload to {directory}', dropBody: 'Release to save files', type: 'Type', copyPath: 'Copy path', moveRename: 'Move or rename', selected: '{count} selected', useSelected: 'Use selected file', useCount: 'Use {count} files',
  ...
  jp: {
    ...
    assets: {
      ...
      dropTitle: '{directory} にアップロード', dropBody: '離すと保存します', type: '種類', copyPath: 'パスをコピー', moveRename: '移動または名前変更', selected: '{count} 件選択', useSelected: '選択したファイルを使用', useCount: '{count} ファイルを使用',
      ...
      loadFailed: 'ファイルの読み込みに失敗しました', noAccepted: 'この項目で使用できるファイルがありません。', uploadDone: '{count} ファイルを {directory} に追加しました', uploadFailed: 'アップロードに失敗しました', copied: '公開パスをコピーしました', copyFailed: 'クリップボードに書き込めません。手動でパスをコピーしてください。', folderUpdated: 'フォルダーを {path} に更新しました', fileUpdated: 'ファイルを {path} に更新しました',
